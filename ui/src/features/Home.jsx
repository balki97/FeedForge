...
export default function Home({ navigate, chooseFiles, chooseFolder, items, selectItem }) {
  return <section className="home-workspace">
    ...
    <div className="home-actions">
      <button onClick={() => navigate("workspace")}><Guitar/><span><strong>Convertor</strong><small>Single files, folders and conversion queues</small></span><ArrowUpRight size={17}/></button>
