...
function App() {
  ...
  async function convertQueue() {
    ...
    try {
      const linkedItems = conversionPending.filter((item) => usesSharedRs1SongsAudio(item.path));
      const regularItems = conversionPending.filter((item) => !usesSharedRs1SongsAudio(item.path));
